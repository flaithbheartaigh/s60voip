/* $Id: symbian_ua.cpp 11 2010-02-17 13:08:52Z Bob $ */
/* 
...
// TODO : robert, this was "extern" in pjsua_internal.h
...
int symbian_im_send(const char *uri, char *content)
{
    ...
    if (status == PJ_SUCCESS)
    {
    	pj_str_t tmp_uri = pj_str((char*)uri);
    	pj_str_t tmp_content = pj_str(content);
    	return pjsua_im_send(acc_info.id, 
    			&tmp_uri, 
    			NULL, 
    			&tmp_content,
				NULL, 
